...
('Epee de Legolas', 'L épée utilisée par Legolas dans le Seigneur des Anneaux', 1500, 200, '2023-05-01 00:00:00', '2023-06-01 00:00:00', 1, 1),
('Fleur de Lotus', 'La fleur utilisée par Neo dans Matrix', 200, 50, '2023-07-01 00:00:00', '2023-08-01 00:00:00', 1, 1),
('Kylo Ren saber', 'Le sabre laser utilisé par Kylo Ren dans Star Wars épisode 7', 1000, 100, '2023-09-01 00:00:00', '2023-10-01 00:00:00', 1, 1),
('La coupe de Vif-Argent', 'La coupe utilisée par Harry Potter dans le tournoi des 3 sorciers', 1500, 200, '2023-11-01 00:00:00', '2023-12-01 00:00:00', 1, 1),
...
('Armes de Kill Bill', 'Les armes utilisées par Uma Thurman dans Kill Bill', 500, 20, '2023-04-01 00:00:00', '2023-05-01 00:00:00', 1, 1),
('Casque de Iron Man', 'Le casque utilisé par Tony Stark dans Iron Man', 3000, 250, '2023-03-01 00:00:00', '2023-04-01 00:00:00', 1, 1),
('Costume de Spider-Man', 'Le costume utilisé par Tobey Maguire dans Spider-Man', 1500, 100, '2023-02-01 00:00:00', '2023-03-01 00:00:00', 1, 1),
('Manteau de Blade Runner', 'Le manteau utilisé par Harrison Ford dans Blade Runner', 1000, 50, '2023-01-01 00:00:00', '2023-02-01 00:00:00', 1, 1),
...
('Couteau de combat', 'Le couteau utilisé par John Rambo dans Rambo', 500, 50, '2023-09-01 00:00:00', '2023-09-30 00:00:00', 1, 1),
('Costume Spider-Man', 'Le costume complet porté par Tobey Maguire dans Spider-Man', 2000, 200, '2023-10-01 00:00:00', '2023-11-01 00:00:00', 1, 1),
('Arme de Predator', 'L arme utilisée par le Predator dans Predator', 2500, 250, '2023-11-01 00:00:00', '2023-12-01 00:00:00', 1, 1),
('Masque de Jason', 'Le masque porté par Jason Voorhees dans Vendredi 13', 800, 80, '2023-01-01 00:00:00', '2023-02-01 00:00:00', 1, 1),
('Gantelets Iron Man', 'Les gantelets portés par Robert Downey Jr. dans Iron Man', 3500, 350, '2023-11-01 00:00:00', '2023-12-01 00:00:00', 1, 1),
('Chapeau de Indiana Jones', 'Le chapeau porté par Harrison Ford dans Indiana Jones', 1000, 100, '2023-11-01 00:00:00', '2023-12-01 00:00:00', 1, 1),
...
('Arme de RoboCop', 'L arme utilisée par RoboCop dans RoboCop', 1500, 150, '2023-09-01 00:00:00', '2023-10-01 00:00:00', 1, 1),
('Lunettes de Neo', 'Les lunettes portées par Keanu Reeves dans Matrix', 800, 80, '2023-11-01 00:00:00', '2023-12-01 00:00:00', 1, 1),
('Casque de Darth Vader', 'Le casque porté par David Prowse dans Star Wars épisode IV', 4000, 400, '2023-09-01 00:00:00', '2023-10-01 00:00:00', 1, 1);